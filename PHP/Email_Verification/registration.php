        ...
        if(isset($_POST['submit'])){
            ...
            if($emailcount>0){
                ...
                if($password === $cpassword){
                    $insertquery = "INSERT INTO registration (username, email, mobile, password, cpassword,token,status) 
                    ...
                    if($iquery){
                        ...
                        $body = "Hi, $username. <br> Click here to activate your account
                        http://localhost/PROJECTS%20(PHP)/Email_Verification/activate.php?token=$token";
                        $sender_email = "From: ankityadav2656@gmail.com";

                        mail($email, $subject, $body, $sender_email);

                        if(mail($email, $subject, $body, $sender_email)){
                            $_SESSION['msg'] = "Check $email to activate account";
